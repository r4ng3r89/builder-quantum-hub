...
export default function VoucherCustomizer({ config, onChange }: VoucherCustomizerProps) {
  const handleColorPresetSelect = (preset: { primary: string; secondary: string }) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value: 'percentage' | 'fixed') => onChange('discountType', value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              <Label htmlFor="discountValue">
                Discount Value ({config.discountType === 'percentage' ? '%' : '$'})
              </Label>
              <Input
                id="discountValue"
                type="number"
